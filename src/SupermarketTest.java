...
class SupermarketTest {
    ...
    void handleEvent_arrival(){
        ...
        supermarketTest.addEventToQueue(new Event(new Customer(0,100),type.CUSTOMER_ARRIVES,0));
        supermarketTest.run();
    ...
    void handleEvent_readyCheckout(){
        Supermarket supermarketTest = new Supermarket(1,0,0);
        supermarketTest.addEventToQueue(new Event(new Customer(0,100),type.CUSTOMER_READY_CHECKOUT,0));
        supermarketTest.run();
