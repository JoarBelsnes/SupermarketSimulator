...
class SupermarketTest {
    ...
    @Test
    void step() {
        Supermarket supermarketTest = new Supermarket(0,1,1,0);
    ...
    void addEventToQueue() {
        Supermarket supermarketTest = new Supermarket(0,0,0,0);
    ...
    void handleEvent_changeLine() {
        Supermarket supermarketTest = new Supermarket(0, 1, 2,0);
